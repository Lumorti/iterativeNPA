...
do
    ...
    do
        ...
        echo "$iter $size $timeGen | $memoryOptim $timeOptim $resultOptim $linOptim $eigOptim | $memoryMosek $timeMosek $resultMosek $linMosek $eigMosek | $memorySCS $timeSCS $resultSCS $linSCS $eigSCS" >> rxx22.dat
    done
done
